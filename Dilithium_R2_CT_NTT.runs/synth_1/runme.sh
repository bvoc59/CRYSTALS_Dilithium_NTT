...
HD_PWD='C:/Users/bvoc5/CRYSTALS_NTT/Dilithium_R2_CT_NTT/Dilithium_R2_CT_NTT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dilithium_R2_CT_NTT_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dilithium_R2_CT_NTT_top.tcl
