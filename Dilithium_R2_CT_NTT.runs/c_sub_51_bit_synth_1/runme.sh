...
HD_PWD='C:/Users/bvoc5/CRYSTALS_NTT/Dilithium_R2_CT_NTT/Dilithium_R2_CT_NTT.runs/c_sub_51_bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_sub_51_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_sub_51_bit.tcl
