...
HD_PWD='C:/Users/bvoc5/CRYSTALS_NTT/Dilithium_R2_CT_NTT/Dilithium_R2_CT_NTT.runs/clk_mmcm_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mmcm_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mmcm_wiz.tcl
