...
HD_PWD='C:/Users/bvoc5/CRYSTALS_NTT/Dilithium_R2_CT_NTT/Dilithium_R2_CT_NTT.runs/c_add_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_add_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_add_0.tcl
