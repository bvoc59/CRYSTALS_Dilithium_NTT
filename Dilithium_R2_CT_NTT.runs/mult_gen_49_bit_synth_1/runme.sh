...
HD_PWD='C:/Users/bvoc5/CRYSTALS_NTT/Dilithium_R2_CT_NTT/Dilithium_R2_CT_NTT.runs/mult_gen_49_bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_49_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_49_bit.tcl
