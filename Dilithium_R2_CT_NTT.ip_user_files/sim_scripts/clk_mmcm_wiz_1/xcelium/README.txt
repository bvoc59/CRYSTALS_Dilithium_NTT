...
#
# Generated by export_simulation on Tue Apr 18 23:39:06 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './clk_mmcm_wiz.sh' script.

./clk_mmcm_wiz.sh -reset_run
...
./clk_mmcm_wiz.sh -noclean_files

For more information on the script, please type './clk_mmcm_wiz.sh -help'.
